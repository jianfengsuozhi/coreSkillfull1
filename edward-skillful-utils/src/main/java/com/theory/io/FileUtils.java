...
public class FileUtils extends org.apache.commons.io.FileUtils {
	...
	public static boolean copyDirectoryCover(String srcDirName,
		...
		// 创建目标目录
		logger.debug("目标目录不存在或目标目录在允许覆盖时已删除，准备创建!");
		if (!descDir.mkdirs()) {
	...
	public static boolean unZipFiles(String zipFileName, String descFileName) {
        ...
        try {
			...
			while (enums.hasMoreElements()) {
				...
				System.out.println(descFileDir);
	 ...
	 * @param dirPath 目录名 D:\io\aa\qq.png
	 * @param file entry文件名 D:\
	 * @return io\aa\qq.png
	 */
	...
	public static String path(String path){
		...
		//StringUtils.join 在数组间加入分隔符组成新的字符串
	 ...
	 * 获目录下的文件列表名list
	 * @param dir 搜索目录
	 * @param searchDirs 是否是搜索目录 true:搜索目录 false:搜索文件
	 * @return 文件列表
	 */
	public static List<String> findChildrenNameList(File dir, boolean searchDirs) {
	...
	public static void main(String[] args) {
		//创建文件和目录
//		FileUtils.createFile("D:/io/a.txt");
//		FileUtils.createDirectory("D:/io/aa");
		//删除文件和目录
//		FileUtils.delFile("D:\\io");
		//复制文件目录
//		FileUtils.copyFile("D:\\io\\dbcp.txt", "D:\\io\\dbcp1.txt");
//		FileUtils.copyDirectoryCover("D:\\io", "E:\\io",true);
		//压缩 找出末端+(复制文件内容) 文件类型+(目录的下一级目录个数)
		FileUtils.zipFiles("D:\\","io","D:\\test.zip");
		//解压D:\cc.zip 找到压缩文件,遍历压缩文件创建文件和目录  D:\io/bb.txt  D:\io/aa.txt D:\io/
//		FileUtils.unZipFiles("D:\\io.zip", "D:\\");
		//上传
		//下载
		//其他
		//扩展名去除和获取
//		System.out.println(FileUtils.getFileExtension("a.txt"));
//		System.out.println(FileUtils.getFileNameWithoutExtension("a.txt"));
		//只查看文件或目录
//		List<String> childrenList = FileUtils.findChildrenNameList(new File("D:\\tmp"), false);
		//分隔符
